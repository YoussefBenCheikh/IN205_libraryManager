	        ...
	        <div class="row">
	          <div class="input-field col s6">
	            <select id="idLivre" name="idLivre" class="browser-default">
	              ...
	              <c:if test="${!listeLivresDispo.isEmpty()}">
                  <c:forEach items="${listeLivresDispo}" var="livre">
	          ...
	          <div class="input-field col s6">
	            <select id="idMembre" name="idMembre" class="browser-default">
	              ...
	              <c:if test="${!listeMembreDispo.isEmpty()}">
                    <c:forEach items="${listeMembreDispo}" var="membre">
